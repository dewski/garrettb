...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-02-04}
  s.description = %q{Full-stack web-application framework.}
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionmailer>, ["= 3.0.0.beta"])
      s.add_runtime_dependency(%q<railties>, ["= 3.0.0.beta"])
      ...
      s.add_dependency(%q<actionmailer>, ["= 3.0.0.beta"])
      s.add_dependency(%q<railties>, ["= 3.0.0.beta"])
