...
Also see http://rack.rubyforge.org.
  ...
  s.files = ["lib/paperclip_processors", "lib/paperclip_processors/cropper.rb", "lib/tasks", "COPYING", "KNOWN-ISSUES", "rack.gemspec", "RDOX", "README", "SPEC", "test/test_helper.rb", "bin/rackup"]
