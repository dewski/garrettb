...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/dirs/authlogic/bin")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/../../../../../../paperclip/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/../../../../../../paperclip/lib")
